        ...
        <asp:Panel ID="pnlDetails" runat="server" Visible="false">
            ...
            <div id="pnlEditDetails" runat="server" class="well">
                ...
                <fieldset>
                    ...
                    <div class="row-fluid">
                        <div class="span6">
                            <Rock:DataDropDownList ID="DataDropDownList1" runat="server" LabelText="Pick a metric" />
                            <Rock:DateTimePicker ID="DateTimePicker1" runat="server" LabelText="Start Date" />
                            <Rock:DateTimePicker ID="DateTimePicker2" runat="server" LabelText="End Date" />
                            <Rock:DataDropDownList ID="DataDropDownList2" runat="server" LabelText="Size" />
                            <Rock:DataDropDownList ID="DataDropDownList3" runat="server" LabelText="Number of Columns" />
                            <Rock:DataDropDownList ID="DataDropDownList4" runat="server" LabelText="Number of Rows" />
                            <Rock:DataTextBox ID="DataTextBox2" runat="server" LabelText="Start Row"></Rock:DataTextBox>
                            <Rock:LabeledTextBox ID="LabeledTextBox1" runat="server" LabelText="Start Column"></Rock:LabeledTextBox>
...
<%--            <fieldset id="fieldsetViewDetails" runat="server">
        ...
        <asp:Panel ID="pnlDefinedTypeAttributes" runat="server" Visible="false">
            <Rock:AttributeEditor ID="edtMetricAttributes" runat="server" OnSaveClick="btnSaveMetricAttribute_Click" OnCancelClick="btnCancelMetricAttribute_Click" />
        </asp:Panel>
